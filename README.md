...
| [SPSS](https://instytut-badan-edukacyjnych.github.io/ilsa-guides/pl/spss.html) | Program statystyczny z graficznym interfejsem, wygodny do pracy z danymi z badań edukacyjnych — wczytywania plików, łączenia kwestionariuszy, sprawdzania rozkładów i przygotowania danych do analiz. W połączeniu z IDB Analyzer umożliwia też poprawne analizy z wagami replikacyjnymi i wartościami prawdopodobnymi (PV). |
