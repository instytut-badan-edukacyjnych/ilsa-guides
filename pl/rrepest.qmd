...
::: {.callout-note}
## Dodatkowe zasoby
- [**Pełna dokumentacja**](https://cran.r-project.org/package=Rrepest/Rrepest.pdf){target="_blank"} - plik PDF zawierający opis funkcji pakietu oraz praktyczne przykłady jego zastosowania w analizie danych z międzynarodowych badań edukacyjnych.
- [**README na CRAN**](https://cran.r-project.org/web/packages/Rrepest/readme/README.html){target="_blank"}  - skrócony przewodnik instalacyjny i opis głównych funkcji pakietu, dostępny na stronie pakietu w CRAN.
- [**Repo/wiki z przykładami (OECD GitLab**)](https://gitlab.algobank.oecd.org/edu_data/rrepest){target="_blank"} - strona, na której znajdziemy aktualizacje pakietu publikowane przez OECD oraz dodatkowe przykłady analiz.
:::
